  ...
  const handleFileChange = async (
    ...
    reader.onload = async () => {
      ...
      const response = await fetch(
        "https://gaurav0203shetty--audio-cnn-inference-audioclassifier-inference.modal.run/",
        {
          method: "POST",
    ...
    reader.onerror = () => {
      setError(`File read error: ${error}`)
      setIsLoading(false)
    }
  }
    ...
    <div className="mx-auto max-w-[100%]">
      ...
      {error && (
        ...
        {vizData && (<div className="space-y-8">
          <Card>
            <CardHeader><CardTitle className="text-stone-900">Top Predictions</CardTitle></CardHeader>
            <CardContent>
